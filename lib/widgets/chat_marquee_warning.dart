...
/// 한 주기 끝의 공백 5칸 뒤 같은 문구가 이어짐.
const String kChatMarqueeSegment = '$kChatConductWarningText     ';
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        final tp = TextPainter(
          text: TextSpan(text: kChatMarqueeSegment, style: style),
          textDirection: TextDirection.ltr,
          maxLines: 1,
        )..layout();
        final segW = tp.width;
        final loopText = kChatMarqueeSegment + kChatMarqueeSegment;
