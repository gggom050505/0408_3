...
/// 이벤트 탭 상단에 붙이는 **앱 이용·응용 가이드** (출석/깜짝선물 본문과 중복 없음).
/// 오프라인 번들 목록에도 끼워 넣고, Supabase 연동 시에는 DB 공지 **앞**에 붙입니다.
  ...
  return [
    EventItemRow(
      ...
      description:
          ...
          '뽑은 배열이 마음에 들면 화면 캡처(또는 공유)로 저장해 두었다가, 「게시물」탭에서 '
          '질문 한 줄과 함께 올려 보세요. 나중에 같은 스프레드를 다시 펼쳐 보며 해석을 덧붙이는 식으로 '
          '일기·기록으로 응용할 수 있어요.\n\n'
    ...
    EventItemRow(
      ...
      description:
          ...
          '• 매일 첫 출석: 별조각 +1은 기본, 「행운이 가득한 날」에는 미보유 유료 품목 1개를 더 드려요.\n'
          '• 깜짝 선물: 2~7일마다 상점에서 같은 방식으로 품목 1개(이미 가진 것은 제외).\n'
          '• 베타 「별조각·광고」: 시청 후 소량 지급(계정당 쿨타임 있음). 광고는 매회 한 편씩 재생돼요.\n\n'
